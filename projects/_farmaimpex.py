...
if __name__ == '__main__':
    ...
    ru = LanguageRules('russian', check_letters=True, with_numbers=True, min_lenght=3, stemming=True, symbols='')
    eng = LanguageRules('english', check_letters=True, with_numbers=True, min_lenght=3, stemming=True, symbols='')
    ...
    concMl = MeasureExtractor(MD.concentrationByMilliliter(), mode='overall', max_values=1)
    ...
    data = getCountsNoRx(data, 'Название', counts='шт|уп|доз|пак', excludeRX=True)
